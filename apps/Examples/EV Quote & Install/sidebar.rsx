<SidebarFrame
  ...
  style={{
    ordered: [{ background: "primary" }, { headerBackground: "#025939" }],
  }}
  width="small"
>
  <Header>
    <Image
      ...
      fit="contain"
      heightType="fixed"
      retoolStorageFileId="ded16bbd-1ea2-47fa-8d76-a599e4e4fef8"
  ...
  <Body>
    ...
    >
      ...
      <Option
        ...
        key="848c6"
        label="Customers"
        screenTargetId="Customers"
      />
      <Option
        id="c2fd7"
        disabled={false}
        hidden={false}
        icon="bold/money-cash-file-dollar"
        iconPosition="left"
        itemType="page"
        label="Quotes"
        screenTargetId="Quotes"
      />
      <Option
        id="f53d6"
